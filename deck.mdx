...
- Some additional HTML elements based on common components like a dropdown list.
- It would automatically be recognized by assistive technologies without any work on our part.
- and the actual dropdown behavior would be managed by the browser, which would be amazing.
