...
- Of coure there are monetary and legal reasons for why we should care about accessibility in our day-to-day
...
- And we have to pass a handler function to it.  The docs say that our button can be activate using the ENTER and SPACE keys, so we're going to check for those keys being pressed.
- CODE TRANSITION
