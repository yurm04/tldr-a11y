...
<Notes>
  ...
  - These elements were built with accessibility in mind. leverage them in the components we build whenever we can.
...
- need a way to assign additional semantic meaning to our elements and components so that assistive technologies can work with them.
...
- together they can be understood by assistive technologies 
- properly communicate to the user the component, how to interact
