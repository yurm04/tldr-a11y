...
<Layout showWebsite={true} theme="light" layout="bigHello">
...
<Layout layout={["sectionBodyLayout", "leftAligned"]}>
...
<Layout layout="blockQuote" theme="light">
...
<Layout layout="sectionTitleBody">
...
<Layout layout="sectionTitleBody" theme="light">
...
# ARIA [Button](https://www.w3.org/TR/wai-aria-practices/#wai-aria-roles-states-and-properties-3)
...
<Layout>
  ...
  <p>Screen Reader: <span class="bold">Submit</span>, button</p>
...
<Layout>
  ...
  <Button>👋</Button>
  <p>Screen Reader: <span className="bold">waving hand</span>, button</p>
...
<Layout>
  ...
  <Button>👋</Button>
  <p>Screen Reader: <span className="bold">Submit form</span>, button</p>
  <p>User: 👍 😌</p>
...
<Layout>
  ...
  <p>Screen Reader: <span className="bold">button</span></p>
  <p>User: 😕 🤔</p>
...
<Layout layout="sectionTitle">
<h1>Keyboard Navigation: <br /><a href="https://www.w3.org/TR/wai-aria-practices/#keyboard-interaction-3">Button</a></h1>
