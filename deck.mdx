...
import designPatternsImage from './designPatterns.png'
import alertDesignPattern from './alertDesignPattern.png'
import alertExample1 from './alertExample1.png'
import alertExample2 from './alertExample2.png'
import alertExample3 from './alertExample3.png'
...
- But for all the good that come out of aira attributes, They don't really help with our next concept...
...
- We're gunna skip our semantic HTML step because we're trying to take a non-semantic element and give it some meaning so nothing to do there.
...
- and we also want to accept an accesible label
...
- setting it to zero will will put the element in it's natural tab order in the DOM so that we can tab or shift tab into it.
...
- we have to add a onClick event handler for mouse interactions.
